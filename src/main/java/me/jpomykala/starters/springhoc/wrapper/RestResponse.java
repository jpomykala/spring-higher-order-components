...
public final class RestResponse<T> {
  ...
  public RestResponse(String msg, int status, T data, PageDetails pageDetails) {
    this.msg = msg;
    this.status = status;
    this.data = data;
  ...
  private RestResponse(String message, HttpStatus status, T data, PageDetails pageDetails) {
    this.msg = message;
